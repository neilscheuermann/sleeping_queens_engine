defmodule TableTest do
  ...
  describe "new/1" do
    # TODO>>>> Refactor this to assign position when setting up new table.
    # Will need to refactor anywhere that calls Player.new/2
    # test "returns a table with required fields and assigns positions when given a list of players" do
    test "returns a table with required fields when given a list of players" do
      player1 = Player.new("Ron", 1)
      player2 = Player.new("Leslie", 2)
  ...
  describe "deal_cards/1" do
    test "returns an updated table, having dealt cards from the draw pile to players until they each have 5 cards" do
      table = Table.new([Player.new("Ron", 1), Player.new("Leslie", 2)])
